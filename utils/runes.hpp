...
namespace mstd {
  ...
  struct apply_rune {
    ...
    using type = T3;
    static constexpr bool value = (std::is_void_v<T> and (rune & TR_VoidOK));
  };
  ...
  constexpr bool is_same_v = apply_rune_v<P, rune> or std::is_same_v<apply_rune_t<P, rune>, Q>;

  template<class P, TypeRune rune = TR_RefOK>
  constexpr bool is_const_v = apply_rune_v<P, rune> or std::is_const_v<apply_rune_t<P, rune>>;

  template<class P, class Q, TypeRune rune = TR_ConstRefOK>
  constexpr bool is_convertible_v = apply_rune_v<P, rune> or std::is_convertible_v<apply_rune_t<P, rune>, Q>;

  template<class P, TypeRune rune = TR_ConstRefOK, class... Args>
  constexpr bool r_is_constructible_v = apply_rune_v<P, rune> or std::is_constructible_v<apply_rune_t<P, rune>, Args...>;

  template<class P, class... Args>
  constexpr bool is_constructible_v = r_is_constructible_v<P, TR_ConstRefOK, Args...>;

  template<class P, TypeRune rune, class... Args>
  constexpr bool is_invocable_v = apply_rune_v<P, rune> or std::is_invocable_v<apply_rune_t<P, rune>, Args...>;

  template<class P, TypeRune rune = TR_ConstRefOK, class... Args>
  constexpr bool predicate = apply_rune_v<P, rune> or std::predicate<apply_rune_t<P, rune>, Args...>;

  template<class P, TypeRune rune = TR_ConstRefOK>
  constexpr bool is_arithmetic_v = apply_rune_v<P, rune> or std::is_arithmetic_v<apply_rune_t<P, rune>>;

  template<class P, TypeRune rune = TR_Strict> // NOTE: strict by default
  constexpr bool is_pointer_v = apply_rune_v<P, rune> or std::is_pointer_v<apply_rune_t<P, rune>>;

  template<class Base, class Derived, TypeRune rune = TR_ConstRefOK>
  constexpr bool is_base_of_v = apply_rune_v<Base, rune> or std::is_base_of_v<apply_rune_t<Base, rune>, Derived>;

  template<class Derived, class Base, TypeRune rune = TR_ConstRefOK>
  constexpr bool is_derived_from_v = apply_rune_v<Derived, rune> or std::is_base_of_v<Base, apply_rune_t<Derived, rune>>;
