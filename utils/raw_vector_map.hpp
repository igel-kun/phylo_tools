...
/*
  ...
  public:
    ...
    using value_type    = std::pair<_Key, _Element>;
    using reference     = std::pair<const _Key, _Element&>;
    using const_reference = std::pair<const _Key, const _Element&>;
    ...
    raw_vector_map_iterator(_Element* _start, size_t _index = 0): 
      start(_start),
      index(_index)
    {}
